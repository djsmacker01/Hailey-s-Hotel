        ...
        const rooms = [
            ...
            },
            {
                ...
                price: 249,
                maxGuests: 3,
                features: ["Free WiFi", "TV", "AC", "Mini Bar", "Coffee Machine", "Separate Living Area"],
                image: "/api/placeholder/400/200"
            },
            {
                id: 4,
        ...
        document.addEventListener('click', (e) => {
            if (!e.target.closest('.menu-toggle') && !e.target.closest('nav') && mainNav.classList.contains('active')) {
                mainNav.classList.remove('active');
            }
        });
        ...
        function displayRooms(type = 'any') {
            ...
            filteredRooms = filteredRooms.filter(room => room.maxGuests >= parseInt(document.getElementById('guests').value));
            
            if (filteredRooms.length === 0) {
                roomsContainer.innerHTML = '<p style="text-align: center; grid-column: 1/-1; padding: 20px;">No rooms matching your criteria. Please adjust your search.</p>';
                return;
            }
            ...
            filteredRooms.forEach(room => {
                ...
                const nights = calculateNights(document.getElementById('check-in').value, document.getElementById('check-out').value);
                ...
                roomCard.innerHTML = `
                    ...
                    <div class="room-details">
                        ...
                        <button class="book-now-btn" data-room-id="${room.id}">Book Now - $${totalPrice} total</button>
                    </div>
                `;
        ...
        function openBookingModal() {
            ...
            confirmationDetails.innerHTML = `
                ...
                <p><strong>Check-in:</strong> ${formatDisplayDate(checkInDate)}</p>
                <p><strong>Check-out:</strong> ${formatDisplayDate(checkOutDate)}</p>
                <p><strong>Guests:</strong> ${guestCount}</p>
                <p><strong>Total:</strong> $${totalPrice} (${nights} nights at $${selectedRoom.price}/night)</p>
            `;
        ...
        bookingForm.addEventListener('submit', (e) => {
            ...
            showToast('Booking successful! Confirmation details have been sent to your email.');
        });
